...
find ./ -type f -exec sed -i -e "s/test-plugin/$1/g" {} \;
find ./ -type f -exec sed -i -e "s/test_plugin/$underscore/g" {} \;
find ./ -type f -exec sed -i -e "s/Test_Plugin/$capitalize_with_underscore/g" {} \;
find ./ -type f -exec sed -i -e "s/TEST_PLUGIN_/$uppercase/g" {} \;
#Rename files
